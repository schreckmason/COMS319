...
$ciphertext = base64_encode(rsa_encrypt($plaintext, $public_key));
file_put_contents("trash_file.txt", $ciphertext);
$readCipherText = base64_decode(file_get_contents("trash_file.txt"));
$decipheredtext = rsa_decrypt($readCipherText, $private_key);
